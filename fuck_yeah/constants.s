...
; 1 fps
SNAKE_MIN_FRAME_TIME_EASY	EQU	1000
; 2 fps
SNAKE_MIN_FRAME_TIME_MEDIUM	EQU	500
; 5 fps
SNAKE_MIN_FRAME_TIME_HARD	EQU	200
; 10 fps
SNAKE_MIN_FRAME_TIME_EXTREME	EQU	100

; queue constants
KEY_QUEUE_CAPACITY	EQU	(1 << 4)
KEY_QUEUE_MASK		EQU	KEY_QUEUE_CAPACITY - 1
SNAKE_QUEUE_CAPACITY	EQU	(1 << 10)
SNAKE_QUEUE_MASK	EQU	SNAKE_QUEUE_CAPACITY - 1
...
ROWS		EQU	240
COLS		EQU	320
CURSOR_ROWS	EQU	(ROWS / 8)
CURSOR_COLS	EQU	(COLS / 8)
ASSET_ROWS	EQU	(ROWS / 10)
ASSET_COLS	EQU	(COLS / 10)
...
game_over_message_len		EQU	game_over_message_after - game_over_message
restart_message_len		EQU	restart_message_after - restart_message
difficulty_message_len		EQU	difficulty_message_after - difficulty_message
instructions_message_len	EQU	instructions_message_after - instructions_message
highscore_message_len		EQU	highscore_message_after - highscore_message
new_highscore_message_len	EQU	new_highscore_message_after - new_highscore_message
